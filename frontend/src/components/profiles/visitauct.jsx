...
import AuctionBids from "../comments/auctionbids"; // Import the AuctionBids component
...
const VisitAuct = ({ userId }) => {
  ...
  const fetchUserAuctions = async () => {
    try {
      ...
      // Fetch auctions for the visited user
      const response = await axios.get(`${API_BASE}/api/auctions?author_id=${userId}`, {
  ...
  // Function to refresh auctions after a bid is placed
    ...
    <div className="flex flex-col lg:flex-row gap-6">
      ...
      <div className="flex-1 space-y-4">
        ...
        {!loading && filteredAuctions.length === 0 ? (
          <p className="text-gray-500 text-center text-sm">No auctions available</p>
        ) : (
