        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              type="text"
              id="title"
              className="w-full px-4 py-2 border border-gray-300 rounded-xl focus:ring-1 focus:ring-blue-500 focus:border-blue-500 text-sm"
              value={title}
          ...
          <div className="mt-4">
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className={`flex-1 px-4 py-3 rounded-xl text-sm font-medium transition-all flex items-center justify-center gap-2 ${visibility === "public"
              ...
              <button
                ...
                className={`flex-1 px-4 py-3 rounded-xl text-sm font-medium transition-all flex items-center justify-center gap-2 ${visibility === "friends"
              ...
              <button
                ...
                className={`flex-1 px-4 py-3 rounded-xl text-sm font-medium transition-all flex items-center justify-center gap-2 ${visibility === "private"
          ...
          <div className="flex justify-end gap-3 pt-2">
            ...
            <button
              ...
              className={`px-4 py-2 text-sm font-medium text-white rounded-xl transition-colors ${isSubmitting
